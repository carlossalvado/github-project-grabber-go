    ...
    <div className="h-screen bg-gray-900 text-white flex flex-col w-full relative">
      ...
      <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-800 to-yellow-900/20 border-b border-yellow-500/20 flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <Avatar className="h-10 w-10 ring-2 ring-yellow-500">
            <AvatarImage src={contactAvatar} alt={contactName} />
            <AvatarFallback className="bg-gradient-to-br from-purple-600 to-yellow-600 text-white">
          ...
          <div>
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-xs text-gray-400">Online - VIP Priority</span>
            </div>
          </div>
        </div>
        
        <div className="flex items-center gap-3">
          <div className="bg-gradient-to-r from-yellow-600 to-orange-600 px-3 py-1 rounded-full flex items-center gap-1">
...
export default ChatUltimatePage;
