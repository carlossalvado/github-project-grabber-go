...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-20 left-10 w-36 h-36 rounded-full overflow-hidden opacity-10 animate-pulse">
        <img 
      ...
      <div className="absolute top-10 left-60 w-28 h-28 rounded-full overflow-hidden opacity-12 animate-pulse delay-500">
        <img 
      ...
      <div className="absolute top-40 left-96 w-32 h-32 rounded-full overflow-hidden opacity-8 animate-pulse delay-1000">
        <img 
      ...
      <div className="absolute bottom-20 right-10 w-28 h-28 rounded-full overflow-hidden opacity-15 animate-pulse delay-1000">
        <img 
      ...
      <div className="absolute bottom-10 right-60 w-24 h-24 rounded-full overflow-hidden opacity-14 animate-pulse delay-1500">
        <img 
      ...
      <div className="absolute bottom-32 right-96 w-36 h-36 rounded-full overflow-hidden opacity-9 animate-pulse delay-2000">
        <img 
          src="/lovable-uploads/d66c0f2d-654b-4446-b20b-2c9759be49f3.png" 
          alt="AI Avatar" 
          className="w-full h-full object-cover"
      ...
      <div className="absolute top-1/3 right-20 w-24 h-24 rounded-full overflow-hidden opacity-10 animate-pulse delay-2000">
        <img 
          src="/lovable-uploads/10016974-820c-4484-8c72-c1047262ea3f.png" 
          alt="AI Avatar" 
          className="w-full h-full object-cover"
      ...
      <div className="absolute top-1/2 left-5 w-20 h-20 rounded-full overflow-hidden opacity-12 animate-pulse delay-2500">
        <img 
          src="/lovable-uploads/fcaaca87-0b2e-46a9-9679-25e095ad9400.png" 
          alt="AI Avatar" 
          className="w-full h-full object-cover"
      ...
      <div className="absolute top-2/3 right-5 w-32 h-32 rounded-full overflow-hidden opacity-11 animate-pulse delay-3000">
        <img 
          src="/lovable-uploads/265b8a08-5c79-4954-b4b1-4bfb6f5a76bb.png" 
          alt="AI Avatar" 
          className="w-full h-full object-cover"
